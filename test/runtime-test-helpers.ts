...
export function createRuntimeOptions(params: {
  ...
  timeoutMs?: number;
  authCredentials?: AcpRuntimeOptions["authCredentials"];
  authPolicy?: AcpRuntimeOptions["authPolicy"];
  isolateClaudeUserSettings?: AcpRuntimeOptions["isolateClaudeUserSettings"];
}): AcpRuntimeOptions {
  return {
    cwd: params.cwd,
    ...
    isolateClaudeUserSettings: params.isolateClaudeUserSettings,
